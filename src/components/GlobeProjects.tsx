...
const PROJECTS = [
  { name: "Rubix",         tag: "Coming soon", desc: "AI terminal agent for developers. Code, deploy, debug — all from your CLI.",        color: "var(--accent)" },
  { name: "9Ruby OS",      tag: "In dev",       desc: "A next-gen operating layer for solo operators. AI-native from the ground up.",       color: "#ff5a78" },
  { name: "Nine Builder",  tag: "Beta",         desc: "Visual page builder that works with any stack. Elementor for the modern web.",       color: "var(--accent)" },
  { name: "Voice Agents",  tag: "Live",         desc: "Sub-500ms AI voice systems for inbound support, outbound calls & booking.",          color: "#22c55e" },
  { name: "Terminal9",     tag: "In dev",       desc: "Browser-based terminal with AI co-pilot. Run commands, ask questions, ship faster.", color: "var(--accent)" },
  ...
  { name: "GitNexus",      tag: "In dev",       desc: "Code intelligence graph. Impact analysis, smart rename, codebase navigation.",       color: "var(--accent)" },
  { name: "IXR Cloud",     tag: "Coming soon",  desc: "Managed cloud infra for IX Ruby clients. One-click deploys, zero ops.",             color: "var(--accent)" },
  ...
  return (
    <section className="relative overflow-hidden py-20 px-4">
      ...
      <div className="max-w-6xl mx-auto text-center mb-4">
        <span className="text-xs uppercase tracking-widest" style={{ color: "var(--accent)" }}>9Ruby Universe</span>
