...
export const blogArticles: BlogArticle[] = [
  {
    id: 13,
    slug: "how-to-turn-a-small-business-website-into-a-daily-lead-engine",
    title: "How to Turn a Small Business Website Into a Daily Lead Engine",
    excerpt:
      "A practical 9Ruby playbook for turning traffic into booked audits, implementation projects, and recurring automation revenue.",
    date: "May 2026",
    readTime: "9 min read",
    category: "Marketing",
    gradient: "linear-gradient(135deg, #F4EFE6 0%, #D8CAB8 45%, #A79580 100%)",
    insights: [
