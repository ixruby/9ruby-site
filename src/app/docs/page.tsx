          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3" style={{ border: BORDER }}>
            {docSections.map((section, i) => (
              ...
              >
                ...
                <span className="inline-flex items-center gap-1.5 group-hover:gap-3 transition-all" style={{ fontFamily: NV, fontWeight: 800, fontSize: 11, letterSpacing: "0.08em", textTransform: "uppercase", color: "#fff" }}>
