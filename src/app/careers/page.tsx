    ...
    <main id="main-content" style={{ background: "#000", minHeight: "100vh", fontFamily: NV }}>
      ...
      <section style={{ background: "#8C000E" }} className="pt-36 pb-16 md:pt-40 md:pb-20">
        <div className="max-w-[1200px] mx-auto px-6 text-center">
          <p style={{ fontFamily: NV, fontSize: 11, fontWeight: 700, letterSpacing: "0.12em", textTransform: "uppercase", color: "rgba(255,255,255,0.6)", marginBottom: 20 }}>Careers</p>
        ...
        <div className="max-w-[1200px] mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2" style={{ border: BORDER }}>
            <div className="p-10 md:p-14" style={{ borderRight: BORDER }}>
              <p style={{ fontFamily: NV, fontSize: 11, fontWeight: 700, letterSpacing: "0.12em", textTransform: "uppercase", color: "#C8102E", marginBottom: 16 }}>Culture</p>
            ...
            <div className="p-10 md:p-14 flex flex-col gap-6">
              {[
                ...
                { label: "Location", value: "Remote-first, India-based" },
      ...
      <section className="py-16 md:py-20" style={{ borderBottom: BORDER }}>
        <div className="max-w-[1200px] mx-auto px-6">
          <div className="mb-12">
            <p style={{ fontFamily: NV, fontSize: 11, letterSpacing: "0.12em", textTransform: "uppercase", color: "rgba(255,255,255,0.4)", marginBottom: 16 }}>* Values</p>
      ...
      <section className="py-16 md:py-20" style={{ borderBottom: BORDER }}>
        <div className="max-w-[1200px] mx-auto px-6">
          <div className="mb-12">
            <p style={{ fontFamily: NV, fontSize: 11, letterSpacing: "0.12em", textTransform: "uppercase", color: "rgba(255,255,255,0.4)", marginBottom: 16 }}>* Open Positions</p>
            <h2 style={{ fontFamily: NV, fontWeight: 950, textTransform: "uppercase", letterSpacing: "-0.075em", lineHeight: 0.93, fontSize: "clamp(2.5rem,6vw,4.5rem)", color: "#fff" }}>
              CURRENT<br />OPENINGS
            </h2>
          </div>
              ...
              >
                <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-5 mb-4">
                  ...
                  <Link
                    ...
                    style={{ fontFamily: NV, fontWeight: 800, fontSize: 10, letterSpacing: "0.1em", textTransform: "uppercase", background: "#C8102E", color: "#fff", padding: "9px 20px", textDecoration: "none" }}
                  >
