...
export default function BlogPage() {
  ...
  return (
    <main id="main-content" style={{ background: "#000", minHeight: "100vh", fontFamily: NV }}>
          ...
          <div className="max-w-[1200px] mx-auto px-6">
            <div style={{ border: BORDER }} className="grid grid-cols-1 md:grid-cols-2">
              ...
              <div className="p-8 md:p-12 flex flex-col justify-center gap-4">
                <span style={{ fontFamily: NV, fontSize: 11, fontWeight: 700, letterSpacing: "0.12em", textTransform: "uppercase", color: "#fff", display: "block" }}>
                  {featured.category}
                </span>
                ...
                <div>
                  <Link href={`/blog/${featured.slug}`} className="inline-flex items-center gap-2 hover:opacity-90 transition-opacity" style={{ fontFamily: NV, fontSize: 11, fontWeight: 800, letterSpacing: "0.12em", textTransform: "uppercase", background: "#fff", color: "#080808", padding: "10px 24px", textDecoration: "none" }}>
      ...
      {/* AUDIT CTA */}
      <section style={{ background: "#000", borderTop: BORDER, borderBottom: BORDER }} className="py-12">
        <div className="max-w-[1200px] mx-auto px-6 flex flex-col md:flex-row md:items-center md:justify-between gap-6">
          <div>
            <p style={{ fontFamily: NV, fontSize: 11, fontWeight: 800, letterSpacing: "0.12em", textTransform: "uppercase", color: "rgba(255,255,255,0.5)", marginBottom: 10 }}>Turn insight into action</p>
            <h2 style={{ fontFamily: NV, fontWeight: 950, textTransform: "uppercase", letterSpacing: "-0.065em", lineHeight: 0.95, fontSize: "clamp(28px,4vw,48px)", color: "#fff" }}>
              Want this applied to your website?
            </h2>
          </div>
          <Link href="/pricing#audit" className="inline-flex items-center gap-2 hover:opacity-90 transition-opacity" style={{ fontFamily: NV, fontSize: 11, fontWeight: 900, letterSpacing: "0.12em", textTransform: "uppercase", background: "#fff", color: "#080808", padding: "13px 24px", textDecoration: "none" }}>
            Get the $49 audit <ArrowRight size={11} />
          </Link>
        </div>
      </section>
