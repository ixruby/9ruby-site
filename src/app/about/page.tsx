  ...
  return (
    <main id="main-content" style={{ background: "#000", minHeight: "100vh", fontFamily: NV }}>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4">
            {stats.map((s, i) => (
              <div key={s.label} className="py-10 px-6 text-center" style={{ borderRight: i % 2 === 0 || i < 3 ? BORDER : "none", borderBottom: i < 2 ? BORDER : "none" }}>
                <div style={{ fontFamily: NV, fontWeight: 950, fontSize: "clamp(28px,5vw,40px)", color: "#C8102E", letterSpacing: "-0.05em", lineHeight: 1, marginBottom: 6 }}>{s.value}</div>
      ...
      <section className="py-16 md:py-20" style={{ borderBottom: BORDER }}>
        <div className="max-w-[1200px] mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-20">
            {/* Story */}
            <div>
              <p style={{ fontFamily: NV, fontSize: 11, fontWeight: 700, letterSpacing: "0.12em", textTransform: "uppercase", color: "#C8102E", marginBottom: 16 }}>Our Story</p>
            ...
            {/* Timeline */}
            <div>
              <p style={{ fontFamily: NV, fontSize: 11, fontWeight: 700, letterSpacing: "0.12em", textTransform: "uppercase", color: "#C8102E", marginBottom: 16 }}>Milestones</p>
              <h2 style={{ fontFamily: NV, fontWeight: 950, textTransform: "uppercase", letterSpacing: "-0.06em", lineHeight: 0.93, fontSize: "clamp(36px,5vw,52px)", color: "#fff", marginBottom: 28 }}>
                TIMELINE
              </h2>
                ...
                {milestones.map((m, i) => (
                  <div key={m.year} className="flex gap-5">
                    <div className="flex flex-col items-center">
                      <div style={{ width: 8, height: 8, borderRadius: "50%", background: "#C8102E", marginTop: 3, flexShrink: 0 }} />
                      {i < milestones.length - 1 && <div style={{ width: 1, flex: 1, background: "rgba(255,255,255,0.12)", minHeight: 32 }} />}
                    </div>
                    <div className="pb-6">
                      <span style={{ fontFamily: NV, fontSize: 10, fontWeight: 700, letterSpacing: "0.12em", textTransform: "uppercase", color: "#C8102E", display: "block", marginBottom: 4 }}>{m.year}</span>
      ...
      <section style={{ borderBottom: BORDER }} className="py-16 md:py-20">
        <div className="max-w-[1200px] mx-auto px-6 text-center">
          <Bot size={32} style={{ color: "#C8102E", margin: "0 auto 24px" }} />
          <p style={{ fontFamily: NV, fontSize: 11, fontWeight: 700, letterSpacing: "0.12em", textTransform: "uppercase", color: "#C8102E", marginBottom: 16 }}>Mission</p>
      ...
      <section className="py-16 md:py-20" style={{ borderBottom: BORDER }}>
        <div className="max-w-[1200px] mx-auto px-6">
          <div className="mb-12 flex flex-col md:flex-row md:items-end md:justify-between gap-6">
            <div>
              <p style={{ fontFamily: NV, fontSize: 11, fontWeight: 700, letterSpacing: "0.12em", textTransform: "uppercase", color: "#C8102E", marginBottom: 16 }}>Principles</p>
      ...
      <section className="py-16 md:py-20" style={{ borderBottom: BORDER }}>
        <div className="max-w-[1200px] mx-auto px-6">
          <div className="mb-12">
            <p style={{ fontFamily: NV, fontSize: 11, fontWeight: 700, letterSpacing: "0.12em", textTransform: "uppercase", color: "#C8102E", marginBottom: 16 }}>People</p>
            ...
            {team.map((t, i) => (
              <div key={t.name} className="p-7 flex flex-col gap-4" style={{ borderRight: (i + 1) % 4 !== 0 ? BORDER : undefined, borderBottom: i < 2 ? BORDER : undefined }}>
                ...
                <div>
                  ...
                  <span style={{ fontFamily: NV, fontSize: 10, fontWeight: 700, letterSpacing: "0.12em", textTransform: "uppercase", color: t.tag === "Human" ? "rgba(255,255,255,0.4)" : "#C8102E", border: t.tag === "Human" ? BORDER : "0.8px solid rgba(200,16,46,0.4)", padding: "3px 10px" }}>
                    {t.tag}
                  </span>
                </div>
              </div>
      ...
      <section className="py-16 md:py-20" style={{ borderBottom: BORDER }}>
        <div className="max-w-[1200px] mx-auto px-6">
          <div className="mb-12">
            <p style={{ fontFamily: NV, fontSize: 11, fontWeight: 700, letterSpacing: "0.12em", textTransform: "uppercase", color: "#C8102E", marginBottom: 16 }}>Infrastructure</p>
            <h2 style={{ fontFamily: NV, fontWeight: 950, textTransform: "uppercase", letterSpacing: "-0.06em", lineHeight: 0.93, fontSize: "clamp(40px,6vw,64px)", color: "#fff", marginBottom: 12 }}>
              MEET PRISM.
            </h2>
            <p style={{ fontFamily: NV, fontSize: 14, color: "rgba(255,255,255,0.44)", maxWidth: 480 }}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5" style={{ border: BORDER }}>
            {prismAgents.map((agent, i) => (
              <div key={agent.name} className="p-6 flex flex-col gap-3" style={{ borderRight: (i + 1) % 5 !== 0 ? BORDER : undefined, borderBottom: BORDER }}>
                <div style={{ fontFamily: NV, fontSize: 13, fontWeight: 950, letterSpacing: "0.08em", color: "#C8102E" }}>{agent.name}</div>
      ...
      <section className="py-16 md:py-20" style={{ borderBottom: BORDER }}>
        <div className="max-w-[1200px] mx-auto px-6">
          <div className="mb-12 flex flex-col md:flex-row md:items-end md:justify-between gap-6">
            <div>
              <p style={{ fontFamily: NV, fontSize: 11, fontWeight: 700, letterSpacing: "0.12em", textTransform: "uppercase", color: "#C8102E", marginBottom: 16 }}>Our Stack</p>
              <h2 style={{ fontFamily: NV, fontWeight: 950, textTransform: "uppercase", letterSpacing: "-0.06em", lineHeight: 0.93, fontSize: "clamp(40px,6vw,64px)", color: "#fff" }}>
                TOOLS WE USE
              </h2>
            </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6" style={{ border: BORDER }}>
            {[
              ...
              <div key={col.cat} className="p-6 flex flex-col gap-3" style={{ borderRight: (i + 1) % 6 !== 0 ? BORDER : undefined, borderBottom: BORDER }}>
                <span style={{ fontFamily: NV, fontSize: 10, fontWeight: 800, letterSpacing: "0.12em", textTransform: "uppercase", color: "#C8102E" }}>{col.cat}</span>
                {col.tools.map((t) => (
