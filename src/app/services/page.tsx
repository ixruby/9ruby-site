...
import NicheServiceLinks from "@/components/NicheServiceLinks"
          ...
          <div className="grid grid-cols-2 md:grid-cols-4">
            {stats.map((s, i) => (
              <div key={s.label} className="py-10 px-6 text-center" style={{ borderRight: i % 2 === 0 || i < 3 ? BORDER : "none", borderBottom: i < 2 ? BORDER : "none" }}>
                <div style={{ fontFamily: NV, fontWeight: 950, fontSize: "clamp(28px,5vw,40px)", color: "#fff", letterSpacing: "-0.05em", lineHeight: 1, marginBottom: 6 }}>
                  {s.value}
                </div>
            ...
            {services.map((s, i) => (
              ...
              >
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                  ...
                  <div style={{ color: "#fff" }}>{s.icon}</div>
                </div>
                <div>
                  ...
                  <ul style={{ listStyle: "none", padding: 0, margin: "0 0 16px", display: "flex", flexDirection: "column", gap: 8 }}>
                    {s.features.map((f) => (
                      <li key={f} style={{ display: "flex", alignItems: "center", gap: 8 }}>
                        <CheckCircle2 size={11} style={{ color: "#fff", flexShrink: 0 }} />
                ...
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", borderTop: BORDER, paddingTop: 16, marginTop: "auto" }}>
                  <div>
                    <span style={{ fontFamily: NV, fontWeight: 950, fontSize: 18, color: "#fff", letterSpacing: "-0.04em" }}>{s.metric}</span>
      ...
      <section className="py-16 md:py-20" style={{ borderTop: BORDER, borderBottom: BORDER }}>
        <div className="max-w-[1200px] mx-auto px-6">
          <div className="text-center mb-14">
            <p style={{ fontFamily: NV, fontSize: 11, fontWeight: 700, letterSpacing: "0.12em", textTransform: "uppercase", color: "#fff", marginBottom: 16 }}>Process</p>
            ...
            {processSteps.map((step, i) => (
              ...
              >
                <div style={{ width: 40, height: 40, border: BORDER, display: "flex", alignItems: "center", justifyContent: "center", position: "relative" }}>
                  <div style={{ color: "#fff" }}>{step.icon}</div>
                  <span style={{ position: "absolute", top: -10, right: -10, fontFamily: NV, fontSize: 10, fontWeight: 800, color: "#fff", letterSpacing: "0.08em" }}>{step.num}</span>
                </div>
                <div>
