    ...
    <main className="min-h-screen" style={{ background: '#F8F7F4' }}>
      ...
      <div className="pt-28 pb-20 max-w-[1400px] mx-auto px-6">
            ...
            return (
              ...
              >
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className={`text-xs font-mono ${s.positive ? 'text-emerald-500' : 'text-red-500'}`}>
                    {s.change}
                  </span>
                </div>
        ...
        <div className="mb-10 animate-slide-up delay-200">
          <h2 className="text-[11px] font-semibold tracking-[0.12em] uppercase mb-4" style={{ color: '#C41A3B' }}>Quick Actions</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-10 animate-slide-up delay-300">
          ...
          <div className="lg:col-span-2 rounded-2xl bg-white hover:shadow-lg hover:shadow-black/[0.03] transition-all duration-300" style={{ border: '1px solid rgba(0,0,0,0.04)' }}>
            <div className="px-6 py-5" style={{ borderBottom: '1px solid rgba(0,0,0,0.04)' }}>
              <h2 className="text-[11px] font-semibold tracking-[0.12em] uppercase" style={{ color: '#C41A3B' }}>Active Projects</h2>
            </div>
          ...
          <div className="rounded-2xl bg-white hover:shadow-lg hover:shadow-black/[0.03] transition-all duration-300" style={{ border: '1px solid rgba(0,0,0,0.04)' }}>
            <div className="px-6 py-5" style={{ borderBottom: '1px solid rgba(0,0,0,0.04)' }}>
              <h2 className="text-[11px] font-semibold tracking-[0.12em] uppercase" style={{ color: '#C41A3B' }}>Monthly Revenue</h2>
            </div>
            <div className="p-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 animate-slide-up delay-500">
          ...
          <div className="rounded-2xl bg-white hover:shadow-lg hover:shadow-black/[0.03] transition-all duration-300" style={{ border: '1px solid rgba(0,0,0,0.04)' }}>
            <div className="px-6 py-5" style={{ borderBottom: '1px solid rgba(0,0,0,0.04)' }}>
              <h2 className="text-[11px] font-semibold tracking-[0.12em] uppercase" style={{ color: '#C41A3B' }}>Recent Activity</h2>
            </div>
          ...
          <div className="rounded-2xl bg-white hover:shadow-lg hover:shadow-black/[0.03] transition-all duration-300" style={{ border: '1px solid rgba(0,0,0,0.04)' }}>
            <div className="px-6 py-5 flex items-center justify-between" style={{ borderBottom: '1px solid rgba(0,0,0,0.04)' }}>
              <h2 className="text-[11px] font-semibold tracking-[0.12em] uppercase" style={{ color: '#C41A3B' }}>Team / Agents</h2>
              <Link
                href="/dashboard/team"
          ...
          <div className="rounded-2xl bg-white hover:shadow-lg hover:shadow-black/[0.03] transition-all duration-300" style={{ border: '1px solid rgba(0,0,0,0.04)' }}>
            <div className="px-6 py-5" style={{ borderBottom: '1px solid rgba(0,0,0,0.04)' }}>
              <h2 className="text-[11px] font-semibold tracking-[0.12em] uppercase" style={{ color: '#C41A3B' }}>System Health</h2>
            </div>
            <div className="p-4 space-y-1">
              {systemHealth.map((s) => {
                const Icon = s.icon
                  ...
                  >
                    ...
                    <div className="flex-1">
                      ...
                      <p className={`text-xs font-mono ${
                        s.status === 'green' ? 'text-emerald-500' : s.status === 'yellow' ? 'text-amber-500' : 'text-red-500'
                      }`}>
                        {statusLabel}
                      </p>
                    </div>
