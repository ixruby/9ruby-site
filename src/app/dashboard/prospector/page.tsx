...
const STATS = [
  { label: "Total Prospects", value: "8", icon: Users, color: "var(--accent)" },
      ...
      <div className="pt-28 pb-10 px-6">
        <div className="max-w-[1280px] mx-auto">
          <div className="flex items-start justify-between gap-6 flex-wrap">
            <div>
              <div className="text-[11px] font-semibold tracking-[0.12em] uppercase mb-2" style={{ color: "var(--accent)" }}>
                      ...
                      >
                        ...
                        <td className="px-6 py-4">
                          <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                            <button className="h-7 px-3 rounded-lg text-xs font-medium flex items-center gap-1.5 transition-all" style={{ background: "rgba(139,107,61,0.06)", color: "var(--accent)" }}>
                              <Zap size={11} /> Pitch
                            </button>
