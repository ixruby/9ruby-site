            ...
            {caseStudies.map((cs, i) => (
              ...
              >
                ...
                <div className="flex flex-wrap gap-2">
                  <span style={{ fontFamily: NV, fontSize: 10, fontWeight: 700, letterSpacing: "0.12em", textTransform: "uppercase", color: "#fff", border: "0.8px solid rgba(255,255,255,0.4)", padding: "3px 10px" }}>
                    {cs.industry}
                  </span>
                  {cs.tags.map((tag) => (
                ...
                <div className="flex items-end justify-between pt-5 mt-auto" style={{ borderTop: BORDER }}>
                  <div>
                    ...
                    <div className="flex items-baseline gap-2">
                      <span style={{ fontFamily: NV, fontWeight: 950, fontSize: "clamp(28px,4vw,40px)", color: "#fff", letterSpacing: "-0.05em", lineHeight: 1 }}>{cs.result}</span>
